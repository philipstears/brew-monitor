...
/**
 * NOTE: These notifications is generated by brew-monitor, not by the grainfather,
 * to make it easy for multiple clients to track when boil addition/sparge water
 * alerts are visible.
 */
interface BoilAlertStateNotification {
    type: "BoilAlertState";
    data: BoilAlertStateData;
}

export interface BoilAlertStateData {
    visible: boolean;
}

interface HeatSpargeWaterAlertStateNotification {
    type: "HeatSpargeWaterAlertState";
    data: HeatSpargeWaterAlertStateData;
}

export interface HeatSpargeWaterAlertStateData {
    visible: boolean;
}
...
export function defaultBoilAlertState(): BoilAlertStateData {
    return {
        visible: false,
    };
}

export function defaultHeatSpargeWaterAlertState(): HeatSpargeWaterAlertStateData {
    return {
        visible: false,
    };
}
