...
/**
 * NOTE: This notification is generated by brew-monitor, not by the grainfather,
 * to make it easy for multiple clients to track when boil addition
 * alerts are visible.
 */
